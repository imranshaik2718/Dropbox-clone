...
interface TangentProps extends HTMLMotionProps<"div"> { }
function Tangent({ className }: TangentProps) {
  return (
...
interface NodeProps extends SVGMotionProps<SVGSVGElement> { }

function NodeSvg({ className }: NodeProps) {
  return (
    <motion.svg
      style={{
