...
interface IconographySvgProps extends SVGMotionProps<SVGSVGElement> {}

function IconographySvg({ className }: IconographySvgProps) {
  return (
    <motion.svg
      style={{
      ...
      className={cn(
        "h-full stroke-2 stroke-transparent fill-inherit",
